...
function init() {
	...
	noChangeSymbolSmall = new esri.symbol.PictureMarkerSymbol("./images/no-change.png", 45, 25);
	noChangeSymbolLarge = new esri.symbol.PictureMarkerSymbol("./images/no-change.png", 75, 40);
    ...
    dojo.connect(map.getLayer("networkLocations"), "onClick", function(evt) {
		...
		var currentConst = organicConstituentSelect[organicConstituentSelect.selectedIndex].attributes.constituent.textContent
		//var displayConst = organicConstituentSelect.selectedOptions[0].attributes.displayname.textContent;
		var displayConst = organicConstituentSelect[organicConstituentSelect.selectedIndex].attributes.displayname.textContent
